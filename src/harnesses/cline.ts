 ...
 * Global only (VS Code globalStorage): ~/Library/Application Support/Code/User/globalStorage/saoudrizwan.claude-dev/settings/cline_mcp_settings.json
 */
...
export const cline: HarnessAdapter = {
  name: 'cline',
  displayName: 'Cline',
  ...
  configPath(_scope, _projectDir) {
    // Cline only has a global config
